...
<body>
	...
	<div id="storeArea" class="store-area">
		...
		<div id="nextStoreBtn" class="command1 next-store-btn" data-main="1">
			<p class="command1__text">大阪マップ</p>
		...
		<div id="dragDropBox" class="drag-drop-box">
			<p class="drag-drop-box__text">ここにドロップ</p>
			<img class="drag-drop-box__img" src="img/drone2.png">
		</div>
	</div>
	...
	<!-- お問い合わせ + フッターエリア -->
	<div id="contactFooterArea" class="contact-footer-area login-area--active">
		<div class="page-overlay login-area__overlay">
			<!-- お問い合わせエリア -->
